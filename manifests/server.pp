class zabbix::server (
  ...
  $history_storage_types     = $::zabbix::params::server_config_history_storage_types,
  $history_storage_url       = $::zabbix::params::server_config_history_storage_url,
  ...
  $socket_dir                = $::zabbix::params::server_config_socket_dir,
  ...
  $start_alerters            = $::zabbix::params::server_config_start_alerters,
  ...
  $start_preprocessors       = $::zabbix::params::server_config_start_preprocessors,
